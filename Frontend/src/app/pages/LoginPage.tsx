...
import { Sun, Mail, Lock, CheckCircle2, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#eff6ff] via-[#f0f9ff] to-[#ecfeff] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="bg-gradient-to-br from-[#2563eb] via-[#0284c7] to-[#0891b2] p-10 text-center relative overflow-hidden">
            ...
            >
              <Sun className="w-10 h-10 text-[#2563eb]" />
            </motion.div>
          ...
          <div className="p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-[#2563eb] via-[#0284c7] to-[#0891b2] text-white py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl transition-all relative overflow-hidden group"
            ...
            {/* Demo Credentials */}
            <motion.div
              className="mt-6 pt-6 border-t-2 border-[#dbeafe]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.8, duration: 0.5 }}
            >
              <motion.div
                className="bg-gradient-to-r from-[#eff6ff] to-[#ecfeff] p-3 rounded-xl"
                whileHover={{ scale: 1.02 }}
              >
                <p className="text-xs text-[#475569] text-center flex items-center justify-center gap-2 font-medium">
