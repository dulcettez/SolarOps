...
import { Sun, Mail, Lock, CheckCircle, XCircle, Eye, EyeOff, Sparkles, AlertCircle } from 'lucide-react';
...
export function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    users.push(newUser);
    localStorage.setItem('solarops_users', JSON.stringify(users));
        ...
        >
          ...
          <div className="p-8">
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-[#1e40af] via-[#0e7490] to-[#0891b2] text-white py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl transition-all relative overflow-hidden group"
